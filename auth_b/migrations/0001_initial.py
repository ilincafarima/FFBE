    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_status', models.CharField(choices=[('free', 'Free'), ('plus', 'Plus'), ('premium', 'Premium')], default='free', max_length=10)),
                ('role', models.CharField(choices=[('client', 'Client'), ('worker', 'Worker')], default='client', max_length=10)),
                ('worker_type', models.CharField(blank=True, max_length=100, null=True)),
